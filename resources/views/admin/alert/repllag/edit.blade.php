...
@section('content')
<div class="content">
    {!! Form::open(['url' => 'admin/alert/repllag/performupdate']) !!}
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('warning_level_secs', $alert->warning_level_secs, ['class' => 'form-control view-order-table-col', 'autofocus' => 'autofocus']) !!}
                    </div>
                    <div class="form-group">
    ...
    <div class="row justify-content-center">
        {!! Form::submit('Change', ['class' => 'btn btn-info', 'disabled' => !$canEdit]) !!}&nbsp;<a href="/admin/alert/repllag" class="btn btn-danger">Cancel</a>
    </div>
    {!! Form::close() !!}
</div>
@endsection
