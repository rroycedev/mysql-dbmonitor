...
<div class="content">
            ...
            <div class="block-content">
                ...
                <div>
                    <div class="form-group fl">
                            ...
                            <div>
                                <div style="float: left;">{!! Form::text('warning_level', $canEdit, ['class' => 'form-control alert-level-input']) !!}</div>
    ...
    <div class="row justify-content-center">
        {!! Form::submit('Add', ['class' => 'btn btn-info', 'disabled' => !$canEdit ]) !!}&nbsp;<a href="/admin/alert/cpuload" class="btn btn-danger">Cancel</a>
    </div>
    {!! Form::close() !!}
</div>
@endsection
